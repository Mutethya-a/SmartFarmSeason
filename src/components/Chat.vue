...
const suggestedChips = ref([
  { label: 'Seasonal Farm-Fresh Picks', prompt: 'Which farm-fresh fruits and vegetables are best this season and why?', icon: 'mdi-leaf' },
  { label: 'Nutrition Benefits', prompt: 'What are the nutrition benefits of eating tomatoes, carrots, and leafy greens?', icon: 'mdi-food-apple' },
  { label: 'Healthy Meal Ideas', prompt: 'Give me a simple meal plan using farm produce for a healthy week.', icon: 'mdi-silverware-fork-knife' },
  { label: 'Storing Fresh Produce', prompt: 'How should I store farm produce to keep it fresh longer?', icon: 'mdi-fridge' }
])
  ...
  <v-container class="chat-container">
    <v-card class="mx-auto" max-width="400" elevation="4">
        <v-card-title class="bg-primary align-center">
            ...
            Smart Farm Season Produce & Nutrition Guide
        </v-card-title>
      ...
      <v-card-actions class="pa-3">
        <v-text-field
          v-model="userInput"
          label="Ask about farm produce, nutrition, or meal ideas..."
          variant="outlined"
          density="compact"
          hide-details
